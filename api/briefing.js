...
const SECTIONS = {
  international: {
    ...
    system: `Eres mi editor de noticias personal de élite. Tu tarea es buscar en web noticias de las ÚLTIMAS 48H y devolver un briefing parcial MAL NEWS de hasta 28 piezas en 4 secciones internacionales. Es preferible devolver menos piezas frescas y verificadas que rellenar con análisis genérico.
...
ESQUEMA JSON EXACTO (devuelve SOLO estas 4 claves, NO incluyas spainNews ni spainOpinion):
{
  "date": "DD/MM/YYYY",
  "worldNews": [
    /* HASTA 14 piezas, pero menos si no hay tantas frescas. Equilibrio left/right.
  ...
  "energy": [
    /* HASTA 4 piezas. Fuentes: Reuters Energy, Bloomberg Energy, S&P Global, Argus, tradingeconomics.com, EIA, IEA. Brent obligatorio si hay movimiento. */
    {"rank": 1, "title": "...", "summary": "...", "source": "...", "url": "...", "publishedDate": "2026-05-07"}
  ],
  "legal": [
    /* HASTA 4 piezas jurídicas con sentencia, decisión o caso concreto del día. Internacional: Law360, American Lawyer, GCR, MLex, Justia. España: El Derecho, Expansión Jurídico, Aranzadi. */
    {"rank": 1, "title": "...", "summary": "...", "source": "...", "url": "...", "publishedDate": "2026-05-07"}
  ]
}
...
- HASTA 14 noticias mundo (equilibrio IZQ/DER, ≥4 regiones distintas)
- HASTA 6 opinión mundo firmada con evento concreto detrás (no análisis evergreen)
- HASTA 4 energía (Brent obligatorio si hay movimiento hoy)
- HASTA 4 legal (sentencias/decisiones del día, internacional o España)
